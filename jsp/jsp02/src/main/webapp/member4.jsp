...
%>
<jsp:setProperty property="id" name="memBean" param="id"/><!-- param태그는 겟파라미터를 가지고 있다 form name과같아야함 -->
<jsp:setProperty property="pwd" name="memBean"  param="pwd"/><!-- property는 memberBean의 필드와 일치!중요 -->
	...
	<table align="center" border="1">
	 ...
	 %>
		 <tr align="center">
		 	...
		 	<td><a href="/jsp02/member4.jsp?command=delMember&id=<%=mbean.getId() %>">삭제</a></td>
		 </tr>
	<%
	 		} //for문 종료
	 	} //if문 종료
